...
def handle_server(server):
    ...
    try:
        ...
        sever_commands = [
            ...
            f'git clone --branch ssl_key_url_list https://github.com/damizhou/trace_spider.git spiderCode',
        ...
        for vpn_info in server["vpn_infos"]:
            ...
            with open(f"current_docker_url_list.txt", 'r', encoding='utf-8') as file:
